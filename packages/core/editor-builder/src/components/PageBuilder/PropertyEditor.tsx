            ...
            <div className="sticky top-0 z-10 border-b bg-white px-4 py-3">
                ...
                <div className="mt-3 flex gap-2 border-b">
                    <button
                        ...
                        className={`border-b-2 px-3 py-2 text-sm font-medium transition-colors ${activeTab === "props"
                    ...
                    <button
                        ...
                        className={`border-b-2 px-3 py-2 text-sm font-medium transition-colors ${activeTab === "common"
                                ? "border-blue-500 text-blue-600"
                                : "border-transparent text-gray-500 hover:text-gray-700"
                            }`}
                    >
